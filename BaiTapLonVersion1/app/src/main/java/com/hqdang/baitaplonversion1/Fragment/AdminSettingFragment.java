...
import com.hqdang.baitaplonversion1.DangNhap.LogInActivity;
...
public class AdminSettingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_admin_setting, container, false);
    ...
    private void getControls() {
        ...
        btFeedBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL,new String[]{"huadang131@gmail.com"});
